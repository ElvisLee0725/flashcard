            ...
            return (
                <div className="basic-modal" onClick={this.closeModal}>
                    <div onClick={(e) => e.stopPropagation()} className="basic-modal-content">
                        ...
                        <h5 className="delete-title mb-4">Are you sure you want to delete this card?</h5>
                        <p className="mb-2">{`Q: ${activeCard.question}`}</p>
                        <p className="mb-2">{`A: ${activeCard.answer}`}</p>
                        <div className="text-right mt-4">
                            <button type="button" className="btn btn-outline-secondary mr-2" onClick={this.closeModal}>Cancel</button>
                            <button type="button" className="btn btn-danger" onClick={this.confirmRemove}>Confirm</button>
                        </div>
                    </div>
                </div>
            );
